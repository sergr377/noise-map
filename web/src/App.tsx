        ...
        <div className="map-placeholder">
          {mapError ? (
            <div className="map-error">
              ...
              <p>{mapError}</p>
              <p className="note">
                Чаще всего причина — ключ, выпущенный не для «JavaScript API и HTTP Геокодер»,
                либо неактивированный тариф. Проверьте ключ в кабинете разработчика Яндекс Карт
                и подставьте его в <code>.env</code>.
              </p>
            </div>
          ) : (
      ...
      <div className="panel">
        ...
        {busy && (
          <div className="progress" role="status">
            ...
            <p className="note">
              Первый расчёт для нового места занимает 1–2 минуты. Соседние клики отдаются из
              кэша мгновенно.
            </p>
          </div>
        )}
